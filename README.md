...
|---|---|---|
| **history** — 24 × `instance_NN.json` | the robot's pose and the policy's action at every recorded step, plus the frictions that built the scene | the referee writes `/data/history/`; collected as `FileType.HISTORY` |
